  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      ...
      <section id="how-it-works" className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">How Otto Onboards in 3 Steps</h2>
            <p className="text-slate-600 max-w-2xl mx-auto">
              We wire Twilio, ElevenLabs, and n8n together so every inbound call instantly reaches the right workflow.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12 relative">
            ...
            {[
              ...
              },
              {
                ...
                desc: 'Otto listens over WebSocket, runs your script, and posts intent + caller data to the AI Router webhook /otto/ai-router.'
              },
              {
                step: 3,
      ...
      <section id="industries" className="py-20 bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {[
              { name: "Medical Clinics", desc: "Triage patients, book appointments, and handle FAQs securely.", href: "/industries/medical" },
              { name: "Med-Spas", desc: "Capture high-value cosmetic leads and reduce no-shows.", href: "/industries/med-spa" },
              { name: "Real Estate", desc: "Qualify buyers/sellers instantly and route hot leads to agents.", href: "/industries/real-estate" },
              { name: "Home Services", desc: "Book HVAC, plumbing, and electrical jobs while you're in the field.", href: "/industries/home-services" },
              { name: "Insurance", desc: "Route claims, quote requests, and policy questions efficiently.", href: "/industries/insurance" },
              { name: "Law Firms", desc: "Professional intake for potential clients 24/7.", href: "/industries/legal" },
              { name: "Property Mgmt", desc: "Handle tenant maintenance requests and leasing inquiries.", href: "/industries/property-management" },
              { name: "Restaurants", desc: "Take reservations, handle takeout orders, and answer hours/location questions.", href: "/industries/restaurants" },
              { name: "Auto Dealerships", desc: "Schedule test drives, service appointments, and route sales calls.", href: "https://ottoagent.net" },
            ].map((ind, i) => (
              <div key={i} className="bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-blue-500 transition-colors group">
                ...
                <a href={ind.href} className="text-blue-400 text-sm font-semibold flex items-center gap-1 hover:gap-2 transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="border-2 border-blue-600 rounded-2xl p-8 relative shadow-xl">
              ...
              <div className="text-4xl font-extrabold text-slate-900 mb-6">$2,499<span className="text-lg font-normal text-slate-500">/mo</span></div>
              <ul className="space-y-4 mb-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><a href="/industries/medical" className="hover:text-white transition-colors">Medical Clinics</a></li>
                <li><a href="/industries/med-spa" className="hover:text-white transition-colors">Med-Spas</a></li>
                <li><a href="/industries/real-estate" className="hover:text-white transition-colors">Real Estate</a></li>
                <li><a href="/industries/home-services" className="hover:text-white transition-colors">Home Services</a></li>
                <li><a href="/industries/insurance" className="hover:text-white transition-colors">Insurance</a></li>
                <li><a href="/industries/legal" className="hover:text-white transition-colors">Law Firms</a></li>
                <li><a href="/industries/property-management" className="hover:text-white transition-colors">Property Management</a></li>
                <li><a href="/industries/restaurants" className="hover:text-white transition-colors">Restaurants</a></li>
                <li><a href="https://ottoagent.net" className="hover:text-white transition-colors">Auto Dealerships</a></li>
              </ul>
            </div>
            <div>
