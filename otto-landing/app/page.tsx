...
const integrationPartners = [
  { name: "Salesforce", src: "/logos/salesforce.icon.png" },
  { name: "HubSpot", src: "/logos/hubspot.icon.png" },
  { name: "Google", src: "/logos/google.icon.png" },
  { name: "Outlook", src: "/logos/outlook.icon.png" },
  { name: "Zapier", src: "/logos/zapier.icon.png" },
];
  ...
  >([
    {
      role: "assistant",
      content:
        "Hi, I'm OttoAI! Ask me anything about pricing, features, or how we can help your business.",
    },
  ]);
    ...
    try {
      ...
      setChatMessages((prev) => [
        ...prev,
        {
          role: "assistant",
          content:
            "Sorry, something went wrong. Please try again or call us at (888) 411-8568.",
        },
      ]);
    } finally {
    ...
    <div className="min-h-screen bg-slate-950 font-sans text-white">
                ...
                <div className="space-y-4 mb-6">
                  <div className="bg-slate-50 p-3 rounded-lg rounded-tl-none max-w-[85%]">
                    <p className="text-sm text-slate-700">
                      Thanks for calling Dr. Smith's office. This is OttoAI. How
                  ...
                  <div className="bg-slate-50 p-3 rounded-lg rounded-tl-none max-w-[85%]">
                    <p className="text-sm text-slate-700">
                      I can help with that. We have an opening at 2:00 PM or
                      4:30 PM on Tuesday. Which works better?
                    </p>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-16 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
            {[
              ...
              <span
                key={industry}
                className="text-xl font-bold text-slate-400 flex items-center gap-2"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">
              What OttoAI Handles For You
            </h2>
            <p className="text-lg text-slate-600">
              More than just an answering service—OttoAI is a full-cycle
            ...
            {[
              {
                ...
                desc: "Never let a call go to voicemail. OttoAI answers instantly, day or night.",
                icon: PhoneIcon,
              },
              {
                title: "Lead Qualification",
                desc: "OttoAI asks the right questions to filter spam and prioritize high-value leads.",
                icon: CheckIcon,
              },
              {
                title: "Booking & Reminders",
                desc: "Directly books slots in your calendar and sends SMS reminders automatically.",
                icon: CalendarIcon,
              },
              {
                title: "Intake & Data Entry",
                desc: "Collects caller info and syncs it instantly to your CRM or database.",
                icon: MenuIcon,
              },
            ].map((feature, i) => (
              <div
      ...
      <section className="py-20 bg-slate-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">Before OttoAI</h2>
            <p className="text-slate-400 text-lg">
              The hidden costs of manual phone handling.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "62% of calls to small businesses go unanswered. Every missed call is a customer going to a competitor.",
              },
              {
                title: "Staff Burnout",
                desc: "Your team is interrupted constantly. Receptionists are overwhelmed, and high-value staff are stuck on the phone.",
              },
              {
                title: "Slow Follow-Up",
                desc: "Leads go cold within minutes. If you aren't answering instantly, you're losing the deal.",
              },
            ].map((pain, i) => (
              <div
                key={i}
      ...
      <section id="how-it-works" className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">
              How OttoAI Onboards in 3 Steps
            </h2>
            <p className="text-slate-600 max-w-2xl mx-auto">
              We wire Twilio, ElevenLabs, and n8n together so every inbound call
              instantly reaches the right workflow.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12 relative">
            ...
            {[
              {
                step: 1,
                title: "Point Twilio to OttoAI",
                desc: "Inbound calls hit /api/twilio/voice, where we return streaming TwiML that pipes audio directly to ElevenLabs.",
              },
              {
                step: 2,
                title: "Link the ElevenLabs Agent",
                desc: "OttoAI listens over WebSocket, runs your script, and posts intent + caller data to the AI Router webhook /otto/ai-router.",
              },
              {
                step: 3,
                title: "Trigger n8n + CRM Automations",
                desc: "GPT-4 routing in n8n books calendars, updates PostgreSQL/CRM, and sends SMS/email confirmations from one workflow.",
              },
            ].map((item) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">
              OttoAI for Your Industry
            </h2>
            <p className="text-slate-400 text-lg max-w-2xl mx-auto">
              OttoAI comes pre-trained with workflows and scripts designed
              specifically for your vertical.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Triage patients, book appointments, and handle FAQs securely.",
                href: "/industries/medical",
              },
              {
                name: "Med-Spas",
                desc: "Capture high-value cosmetic leads and reduce no-shows.",
                href: "/industries/med-spa",
              },
              {
                name: "Real Estate",
                desc: "Qualify buyers/sellers instantly and route hot leads to agents.",
                href: "/industries/real-estate",
              },
              {
                name: "Home Services",
                desc: "Book HVAC, plumbing, and electrical jobs while you're in the field.",
                href: "/industries/home-services",
              },
              {
                name: "Insurance",
                desc: "Route claims, quote requests, and policy questions efficiently.",
                href: "/industries/insurance",
              },
              {
                name: "Law Firms",
                desc: "Professional intake for potential clients 24/7.",
                href: "/industries/legal",
              },
              {
                name: "Property Mgmt",
                desc: "Handle tenant maintenance requests and leasing inquiries.",
                href: "/industries/property-management",
              },
              {
                name: "Restaurants",
                desc: "Take reservations, handle takeout orders, and answer hours/location questions.",
                href: "/industries/restaurants",
              },
              {
                name: "Auto Dealerships",
                desc: "Schedule test drives, service appointments, and route sales calls.",
                href: "https://ottoagent.net",
              },
            ].map((ind, i) => (
              <div
                key={i}
                className="bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-blue-500 transition-colors group"
              >
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <div className="border border-slate-200 rounded-2xl p-8">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full py-3 px-4 border border-blue-600 text-blue-600 font-bold rounded-xl hover:bg-blue-50 transition-colors text-center"
              >
                Talk to Sales
              </a>
            </div>
            ...
            <div className="border-2 border-blue-600 rounded-2xl p-8 relative shadow-xl">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full py-3 px-4 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition-colors text-center"
              >
                Talk to Sales
              </a>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              {
                quote:
                  "We used to miss 10 calls a day. Now OttoAI catches everything and our calendar is full.",
                author: "Sarah J.",
                role: "Clinic Manager",
                industry: "Healthcare",
              },
              {
                quote:
                  "It sounds incredibly human. Clients have no idea they're talking to AI until the appointment is booked.",
                author: "Mike T.",
                role: "Owner",
              ...
              {
                quote:
                  "The ROI was immediate. We saved $4k/month on staffing costs in the first month alone.",
                author: "Elena R.",
                role: "Broker",
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Ready to put your incoming calls on autopilot?
          </h2>
          <p className="text-blue-100 text-xl mb-10">
            Join hundreds of businesses saving time and money with OttoAI.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            >
              See how OttoAI works for your industry
            </a>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                a: "Most accounts are live within 24-48 hours. We handle the initial configuration and script setup for you.",
              },
              {
                q: "Does it integrate with my calendar?",
                a: "Yes! OttoAI connects natively with Google Calendar, Outlook, Calendly, and many industry-specific CRMs.",
              },
              {
                q: "Can I customize the script?",
                a: "Absolutely. We start with industry-proven templates, but you can tailor the conversation flow, tone, and specific answers to your needs.",
              },
              {
                q: "What happens if OttoAI doesn't know the answer?",
                a: "You can set up fallback rules. OttoAI can take a message, transfer the call to a human, or direct the caller to your website.",
              },
              {
                q: "Is my data secure?",
                a: "Yes. We use enterprise-grade encryption and comply with major privacy regulations including HIPAA for medical clients.",
              },
            ].map((item, i) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            <div className="col-span-1 md:col-span-1">
              ...
              <p className="text-sm">
                AI Receptionists for Real-World Businesses.
              </p>
            </div>
            <div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-slate-800">
            <p className="text-sm">
              &copy; {new Date().getFullYear()} OttoAI. All rights reserved.
            </p>
      ...
      <div className="fixed bottom-4 right-4 z-50">
        ...
        >
          ...
          <span className="font-semibold">Chat with OttoAI</span>
          <ChevronDownIcon
          ...
          <div className="mt-3 w-80 h-96 bg-white rounded-2xl shadow-2xl border border-slate-200 flex flex-col animate-in slide-in-from-bottom-4 duration-300">
            <div className="px-4 py-3 border-b border-slate-200 bg-gradient-to-r from-blue-600 to-blue-700 rounded-t-2xl">
              ...
              <p className="text-xs text-blue-100">
                Ask anything about OttoAI or book a demo
              </p>
            </div>
